...
<body>
  ...
  <div class="frame frame-short">
    <div class="nav">
        ...
        <label for="password"> SENHA(alfa-numerica):</label><input class="form-styling" type=password required="required" name=campo3><br>
        <input type = "checkbox" required="required"><label>Li e concordo com os <a href="termos.php">termos de uso</a> e <a href="privacidade.php">privacidade</a></label><br>
         <a href=""><button class="btn-signin">Registrar</button></a><br><br>
         <h1>Ja possui uma conta ? <a href="login.php">Clique aqui</a></h1>
        </form>
  </div>
</div>
</div>
