        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="'.$foto.'" alt="..." width="130" class="rounded mb-2 img-thumbnail"><a href="edit_perfil.php" class="btn btn-outline-dark btn-sm btn-block">Editar Perfil</a></div>
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0"> <a href="seguidores.php">
                ...
                <ul class="list-inline mb-0"> <a href="seguindo.php">
                    <li class="list-inline-item">
                       <h5 class="font-weight-bold mb-0 d-block">'.$info["num_follows"].'</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Seguindo</small>
                    </li></a>
                </ul>
            </div>
            <div class="px-4 py-3">
